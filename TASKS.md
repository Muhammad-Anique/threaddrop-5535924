...
2. [ ] Configure Tailwind CSS — files: tailwind.config.ts, postcss.config.mjs; theme: minimalist streetwear (Black, White, Washed Grey, Off-White) | Commit: `chore: add Tailwind CSS config`
...
7. [ ] Build Product Showcase Component — file: components/ProductShowcase.tsx; grid layout, T-shirt designs, placeholder streetwear imagery, minimalist cards | Commit: `feat: add product showcase component`
8. [ ] Build Lead Capture Form Component — file: components/LeadForm.tsx; fields: Name, Email; submission to Supabase `leads` table | Commit: `feat: add lead capture form`
9. [ ] Assemble Main Landing Page — update app/page.tsx; compose: Hero, ProductShowcase, LeadForm, WhatsAppCTA | Commit: `feat: assemble landing page`
